...
const orderdb = JSON.parse(fs.readFileSync('./data/order.json', 'UTF-8'));
...
// api return total price of order
server.get('/api/order/totalPrice', (req, res) => {
  const total_price = orderdb.order.reduce((acc, curr) => {
